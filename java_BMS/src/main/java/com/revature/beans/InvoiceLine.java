...
public class InvoiceLine {
	 ...
	 * A COMPOSITE KEY OBJECT to represent that data. This, in the JPA, is called
	 * an Embeddable. WE have to tell Hibernate we have an EmbeddedId and give it a class.
	 */
	@EmbeddedId
	private InvoiceLineId id;
	/* Because we are currently READING TWO COLUMNS TWICE
	 * AND we don't want to COMPLETELY RUIN our front-end
	 * We have to specify repeated columns should not be
	 * insertable or updateable. AND we need a JSONIgnore
	 */
