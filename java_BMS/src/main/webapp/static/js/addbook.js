...
function addAuthor() {
    let author = JSON.parse(document.getElementById('b_authors').value);
    // add it to book
    ...
    let option = document.getElementById('aopt_'+author.id);
    let select = document.getElementById('b_authors');
