...
window.onload = () => {
    ...
    /*
        Our goal is retrieve the book and then also retrieve
        all of the authors and genres from the database.
        We have to put every author and genre in a dropdown menu
        so that we can select the authors and genres for the book.
    */
    // Promise
    /*
        A promise is a way to synchronize asynchronous calls.
        It will "promise" to call a callback function when the 
    ...
    */
    ...
    getBook.then(function(result){
        // resolve our callback function, success
        getAuthors();
        getGenres();
    }, function(err){
        // resolve our callback function, error
        console.log(err);
    });
    //eventListeners
